  ...
  return (
    <>
      ...
      <nav className="relative z-30 w-full bg-[#0B1F3A]/70 backdrop-blur-md px-10 py-4 flex justify-between items-center text-white">
        ...
        {/* LOGO */}
        <div className="bg-[#E0E0E080] text-[#FAE699] px-6 py-2 text-sm">
          Logo
        </div>

        {/* RIGHT */}
        <div className="flex items-center gap-8">
          <Link to="/about" className="hover:text-[#FFD24A] transition">
            About Us
          </Link>

          <Link to="/contact" className="hover:text-[#FFD24A] transition">
            Contact Us
          </Link>
